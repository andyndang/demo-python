...
class ReferenceProfileItemResponse:
    ...
    download_urls: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('downloadUrls'), 'exclude': lambda f: f is None }})
