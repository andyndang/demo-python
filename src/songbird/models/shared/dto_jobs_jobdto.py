...
from .dto_jobs_jobsettingsdto import DTOJobsJobSettingsDTO
...
class DTOJobsJobDTO:
    ...
    settings: Optional[DTOJobsJobSettingsDTO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('settings'), 'exclude': lambda f: f is None }})
